#!/usr/bin/env bash
#
# One-shot setup for a fresh Ubuntu/Debian (or Amazon Linux) instance:
#   1. Adds a 2G swap file (prevents OOM on 1GB RAM boxes)
...
echo "==> [1/3] Ensuring 2G swap (helps on 1GB RAM boxes)..."
